...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("task5_1.txt", create_str(koef1))
write_file("task5_2.txt", create_str(koef2))
...
write_file("task5_sum.txt", create_str(lst_new))
with open('task5_sum.txt', 'r') as data:
    st3 = data.readlines()
